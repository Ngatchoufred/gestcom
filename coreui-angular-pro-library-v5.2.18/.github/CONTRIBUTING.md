...
The [issue tracker](https://github.com/coreui/coreui-angular-pro/issues) is
...
1. [Fork](https://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/coreui-angular-pro.git
   # Navigate to the newly cloned directory
   cd coreui
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/coreui/coreui-angular-pro.git
   ```
