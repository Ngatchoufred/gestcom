import { Component, EventEmitter, HostBinding, Input, numberAttribute, Output, TemplateRef } from '@angular/core';
...
@Component({
  ...
  standalone: true,
  imports: [PageItemDirective, PageLinkDirective, NgClass]
})
export class SmartPaginationComponent implements ISmartPagination {
   ...
   * @type number
   */
  @Input({ transform: numberAttribute }) activePage: number = 1;
